...
class HudTunerApp:
    def __init__(self, root):
        ...
        tk.Label(render_box, text='GPU ID').pack(anchor='w', pady=(6,0))
        tk.Entry(render_box, textvariable=self.gpu_id_var).pack(fill=tk.X)
    ...
    def render_now(self, layout_path=None):
        ...
        try:
            ...
            tz_offset = 2
        try:
            gpu_id = int(self.gpu_id_var.get())
        except ValueError:
            gpu_id = 0
    ...
    def render_pipeline(self, input_file, meta_path, layout_path, output_file,
                        ...
                        workers=None, tz_offset=2, gpu_id=0):
        ffmpeg_exe  = self.ffmpeg_exe or find_executable('ffmpeg',  [str(self.base_dir / 'ffmpeg.exe'), 'ffmpeg.exe'])
